...
An R-based toolkit for cardiovascular risk modeling. Includes scripts for data cleaning, feature extraction, and custom Random Forest–based classification. 
